...
def dag_gnn(d, npx, npy, max_iter=5, num_epochs=100, seed=1234):
        ...
        while c_A < 1e+20:
            ...
            for graph in [best_ELBO_graph, best_NLL_graph, best_MSE_graph]:
                fdr, tpr, fpr, shd, nnz = count_accuracy(ground_truth_G,
                                                         nx.DiGraph(graph))
                print('fdr:', fdr, 'tpr:', tpr, 'shd:', shd, 'nnz:', nnz)
    ...
    # UPDATE this is mat
    return step_models, best_ELBO_graph