...
parser.add_argument('--data_filename', type=str, default= 'x.pkl',
                    help='data file name containing the discrete files.')
parser.add_argument('--data_dir', type=str, default= '.',
                    help='data file name containing the discrete files.')
parser.add_argument('--data_sample_size', type=int, default=2491,
                    help='the number of samples of data')
parser.add_argument('--data_variable_size', type=int, default=67,
...
def predict(epochs=10, k_max_iter=10, c_A=100):
    args.epochs = epochs
    t_total = time.time()
...
#         print('Best MSE Graph Accuracy: fdr', fdr, ' tpr ', tpr, ' fpr ', fpr, 'shd', shd, 'nnz', nnz)
        ...
        fdr, tpr, fpr, shd, nnz = count_accuracy(ground_truth_G, nx.DiGraph(graph))
        print('Accuracy: fdr', fdr, ' tpr ', tpr, ' fpr ', fpr, 'shd', shd, 'nnz', nnz)
